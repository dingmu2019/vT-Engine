...
exports.INITIAL_AGENTS = exports.DATA_PROMPTS = exports.COMMON_PROMPTS = exports.NAV_TREE = exports.INITIAL_USERS = exports.MOCK_SYSTEM_ERRORS = exports.MOCK_AUDIT_LOGS = exports.MOCK_DATABASE = exports.MOCK_GlobalStandards = exports.INITIAL_INTEGRATIONS = void 0;
exports.INITIAL_INTEGRATIONS = [
    {
        id: 'int_1',
        key: 'llm_global',
...
exports.MOCK_GlobalStandards = `# 全局架构与开发规范 (Global Architecture & Development Standards)
...
你是一位顶级的 企业级业务架构师 (Enterprise Architect) 与 AI 驱动产品专家。你专注于为 B2B SaaS 公司（如 RestoSuite）设计高效的内部 Marketing 和 Sales 支撑系统。`,
        ...
        commonPrompts: exports.COMMON_PROMPTS,
        status: 'active',
...
你是一位精通数据治理与商业智能 (BI) 的数据产品专家。你专注于设计高价值的数据看板（Dashboard）与分析报表。`,
        ...
        commonPrompts: exports.DATA_PROMPTS,
        status: 'active',
        scope: ['dashboard']
    }
];
